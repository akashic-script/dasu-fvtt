...
DASU.inlineAmountVars = [
  ...
  '@skills.athletics.value', '@skills.academia.value', '@skills.craftsmanship.value',
  '@skills.intuition.value', '@skills.medicine.value', '@skills.perceiving.value',
  '@skills.stealth.value', '@skills.outdoorsmanship.value',
  '@lvl', '@dejection',
  '@ap.value', '@ap.max',
  '@sp.value', '@sp.max',
  '@stats.avoid.value', '@stats.defense.value',
  '@stats.hit.value', '@stats.land.value',
