...
export const preloadHandlebarsTemplates = async function () {
  return foundry.applications.handlebars.loadTemplates([
    ...
    // Party actor sheet
    'systems/dasu/templates/actor/party/header.hbs',
    'systems/dasu/templates/actor/party/sidebar.hbs',
    ...
    // Party sidebar
    'systems/dasu/templates/sidebar/party-folders.hbs',
    // Item partials
    ...
    'systems/dasu/templates/table/cell/cell-actor-name.hbs',
    'systems/dasu/templates/table/cell/cell-party-controls.hbs',
    ...
    'systems/dasu/templates/table/expand/expand-party-resistances.hbs',
    'systems/dasu/templates/table/expand/expand-bond.hbs',
    'systems/dasu/templates/table/caption/caption-party-stats.hbs',
    // Dialogs
