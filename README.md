...
![foundry-v14-green](https://img.shields.io/badge/foundry-v14-green)
...
3. Use the following Manifest URL: `https://github.com/akashic-script/dasu-fvtt/releases/latest/download/system.json`
4. Click "Install."
...
4. Make sure the main folder is correctly named: `dasu`
